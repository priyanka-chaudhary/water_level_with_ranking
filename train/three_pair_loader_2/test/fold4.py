...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k4/gt_val_reg.json') as f:
    val = json.load(f)
...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k4/gt_val_rank.json') as f:
    val = json.load(f)
...
model=torch.load('/cluster/work/igp_psr/pchaudha/flood/rank/exp/three_pair_loader/three_pair_loader_7/runs/fold4/rank_model_fold4.pth')
model.eval()
...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k4/gt_test.json') as f:
    train = json.load(f)
