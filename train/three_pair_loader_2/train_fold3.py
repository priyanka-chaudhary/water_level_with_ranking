...
if __name__ == '__main__':
    ...
    path_loc = "/cluster/work/igp_psr/pchaudha/flood/rank/exp/three_pair_loader/three_pair_loader_2/runs/fold3/"
    ...
    # check file is json
    # Regression task
    with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_train_reg.json') as f:
        train = json.load(f)
    ...
    with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_train_rank.json') as f:
        train = json.load(f)
    strJson = json.dumps(train)
    ...
    # check file is json
    with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_val_reg.json') as v1:
        val = json.load(v1)
    ...
    # check file is json
    with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_val_rank.json') as v2:
        val2 = json.load(v2)
        ...
        for epoch in range(num_epochs):
            ...
            for phase in ['train', 'validation']:
                ...
                if phase == 'validation' and epoch_loss < best_loss:
                    ...
                    best_model_wts = copy.deepcopy(model.state_dict())
                    model_p = path_loc + "/rank_model_fold3.pth"
