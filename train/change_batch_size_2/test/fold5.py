...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k5/gt_val_reg.json') as f:
    val = json.load(f)
...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k5/gt_val_rank.json') as f:
    val = json.load(f)
...
model=torch.load('/cluster/work/igp_psr/pchaudha/flood/rank/exp/change_batch_size/change_batch_size_6/runs/fold5/rank_model_fold5.pth')
model.eval()
