...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_val_reg.json') as f:
    val = json.load(f)
...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_val_rank.json') as f:
    val = json.load(f)
...
model=torch.load('/cluster/work/igp_psr/pchaudha/flood/rank/exp/change_batch_size/change_batch_size_6/runs/fold3/rank_model_fold3.pth')
model.eval()
...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k3/gt_test.json') as f:
    train = json.load(f)
