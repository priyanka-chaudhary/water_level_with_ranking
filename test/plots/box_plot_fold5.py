...
with open('/cluster/work/igp_psr/pchaudha/flood/rank/k/k5/gt_test.json') as f:
    train = json.load(f)
...
model=torch.load('/cluster/work/igp_psr/pchaudha/flood/rank/exp/three_pair_loader/three_pair_loader_2/runs/fold5/rank_model_fold5.pth')
model.eval()
...
plt.savefig('/scratch/pchaudha/ranking_loss/plots/box_plot/boxplot_with_points_f5.png', bbox_inches='tight', dpi=1200)
plt.savefig('/scratch/pchaudha/ranking_loss/plots/box_plot/boxplot_with_points_f5.pdf', bbox_inches='tight', dpi=1200)
plt.clf()
#plt.show()
