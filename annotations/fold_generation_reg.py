...
with open('gt_reg_complete.json') as f:
    reg = json.load(f)
...
[fold0_1 , fold0_2, fold0_3, fold0_4, fold0_5, fold0_6] = chunkIt(id_0,6)
...
[fold4_1 , fold4_2, fold4_3, fold4_4, fold4_5, fold4_6] = chunkIt(id_4,6)
[fold5_1 , fold5_2, fold5_3, fold5_4, fold5_5, fold5_6] = chunkIt(id_5,6)
[fold6_1 , fold6_2, fold6_3, fold6_4, fold6_5, fold6_6] = chunkIt(id_6,6)
[fold7_1 , fold7_2, fold7_3, fold7_4, fold7_5, fold7_6, fold7_7] = chunkIt(id_7,6)
[fold8_1 , fold8_2, fold8_3, fold8_4, fold8_5, fold8_6] = chunkIt(id_8,6)
[fold9_1 , fold9_2, fold9_3, fold9_4, fold9_5, fold9_6] = chunkIt(id_9,6)
[fold10_1 , fold10_2, fold10_3, fold10_4, fold10_5, fold10_6] = chunkIt(id_10,6)

fold7_6 = fold7_6+fold7_7
...
for img in test1:
    if img in reg:
        dict_k_1_test[img] = reg[img]

with open('/scratch/pchaudha/ranking_loss/k/k1/gt_test.json', 'w') as fp:
    json.dump(dict_k_1_test, fp, sort_keys = True, indent=4)

# with open('/scratch/pchaudha/ranking_loss/k/k1/gt_train.json', 'w') as fp:
#     json.dump(dict_k_1, fp, sort_keys = True, indent=4)
#
# with open('/scratch/pchaudha/ranking_loss/k/k1/gt_val.json', 'w') as fp:
...
for img in test2:
    if img in reg:
        dict_k_2_test[img] = reg[img]

with open('/scratch/pchaudha/ranking_loss/k/k2/gt_test.json', 'w') as fp:
    json.dump(dict_k_2_test, fp, sort_keys = True, indent=4)

# with open('/scratch/pchaudha/ranking_loss/k/k2/gt_train.json', 'w') as fp:
#     json.dump(dict_k_2, fp, sort_keys = True, indent=4)
#
# with open('/scratch/pchaudha/ranking_loss/k/k2/gt_val.json', 'w') as fp:
...
for img in test3:
    if img in reg:
        dict_k_3_test[img] = reg[img]

with open('/scratch/pchaudha/ranking_loss/k/k3/gt_test.json', 'w') as fp:
    json.dump(dict_k_3_test, fp, sort_keys = True, indent=4)

# with open('/scratch/pchaudha/ranking_loss/k/k3/gt_train.json', 'w') as fp:
#     json.dump(dict_k_3, fp, sort_keys = True, indent=4)
#
# with open('/scratch/pchaudha/ranking_loss/k/k3/gt_val.json', 'w') as fp:
...
for img in test4:
    if img in reg:
        dict_k_4_test[img] = reg[img]

with open('/scratch/pchaudha/ranking_loss/k/k4/gt_test.json', 'w') as fp:
    json.dump(dict_k_4_test, fp, sort_keys = True, indent=4)

# with open('/scratch/pchaudha/ranking_loss/k/k4/gt_train.json', 'w') as fp:
#     json.dump(dict_k_4, fp, sort_keys = True, indent=4)
#
# with open('/scratch/pchaudha/ranking_loss/k/k4/gt_val.json', 'w') as fp:
...
for img in test5:
    if img in reg:
        dict_k_5_test[img] = reg[img]

with open('/scratch/pchaudha/ranking_loss/k/k5/gt_test.json', 'w') as fp:
    json.dump(dict_k_5_test, fp, sort_keys = True, indent=4)

# with open('/scratch/pchaudha/ranking_loss/k/k5/gt_train.json', 'w') as fp:
#     json.dump(dict_k_5, fp, sort_keys = True, indent=4)
#
# with open('/scratch/pchaudha/ranking_loss/k/k5/gt_val.json', 'w') as fp:
